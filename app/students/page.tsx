...
async function restoreStudent(id: string): Promise<void> {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6 text-center">
        ...
        <p className="text-sm text-gray-500 mb-6">
          ...
          <br />
          يمكن استعادته لاحقاً من تبويب &quot;محذوف&quot;
        </p>
        <div className="flex gap-3">
          <button
            onClick={onClose}
...
export default function StudentsPage() {
  ...
  function handlePaymentMade(studentId: string, newPaid: number, newRemaining: number) {
    setStudents((prev) =>
      prev.map((s) =>
        s.id === studentId ? { ...s, paidAmount: newPaid, remainingAmount: newRemaining } : s
      )
    );
  }
              ...
              <table className="w-full text-sm min-w-[900px]">
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-200 text-right">
                    ...
                    <th className="px-4 py-3 font-semibold text-gray-700 whitespace-nowrap">الحالة</th>
                  ...
                  {filtered.map((student) => (
                    <tr key={student.id} className="hover:bg-gray-50 transition">
                      ...
                      <td className="px-4 py-3 whitespace-nowrap">
                        <span
                          className={`font-medium ${
                            student.remainingAmount > 0 ? "text-orange-600" : "text-green-600"
                          }`}
                        >
                      ...
                      <td className="px-4 py-3 whitespace-nowrap">
                        ...
                        >
                          {student.status === "active" ? "نشط" : "محذوف"}
                        </span>
                      </td>
                      <td className="px-4 py-3 whitespace-nowrap">
                        <div className="flex items-center gap-1.5">
                          {student.status === "active" ? (
                            <>
                              ...
                              <a
                                href={`https://wa.me/2${student.phone}`}
                                target="_blank"
                            ...
                            <button
                              ...
                              className="px-2.5 py-1.5 rounded-lg bg-blue-50 text-blue-700 text-xs font-semibold hover:bg-blue-100 disabled:opacity-50 transition"
                            >
                              {actionLoading === student.id ? "..." : "استعادة"}
                            </button>
                          )}
                        </div>
                      </td>
